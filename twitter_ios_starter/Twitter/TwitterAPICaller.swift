...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "yT3rr5Q9V5W0bIvChMCR3z1SQ", consumerSecret: "a7R90WCHGuEdUpalbhMoaghVUidUXWsrxyyMVpHB6REXkIz5dT")
    var loginSuccess: (() -> ())?
